...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of monero birth 2020-02-15 15:16:13 (1581779773)
    var moneroBirthTime = _nettype == "Mainnet" ? 1581779773 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    // avg seconds per block in v1
    var secondsPerBlockV1 = 60;
    // time of v2 2020-02-15 15:18:24 (1581779904)
    var forkTime = _nettype == "Mainnet" ? 1581779904 : _nettype == "Testnet" ? 1448285909 : 1520937818;
    // v2 fork block
